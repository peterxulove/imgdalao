...
function render_uploaded() {
    ...
    uploaded_files.forEach(function (x) {
        ...
        const WPRAW = "https://image.aibici.org/telegra.ph"  //使用wordpress.com加速
		const WPCFRAW = "https://image.aibici.org/imgs.dalao.pro/api"  //使用wordpress.com加速cf,修改后方域名为你的加速域名
        const PhRAW = "https://telegra.ph"   //原地址
        const PROXYURL = "https://image.aibici.org"  //自定义加速域名 默认是使用cloudflare
